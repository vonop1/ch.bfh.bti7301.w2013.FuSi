...
public class CDrawHelper {
    ...
    public static void drawPointAsFilledCircle(Graphics2D g2d, CPosition point, Double size) {
    ...
    public static void drawPolygon(Graphics2D g2d, Vector<CPosition> positions) {
